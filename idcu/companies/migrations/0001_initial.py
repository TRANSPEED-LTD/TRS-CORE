# Generated by Django 5.0.4 on 2024-05-17 22:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('party_type', models.CharField(choices=[('SHIPPER', 'SHIPPER'), ('FORWARDER', 'FORWARDER'), ('CAREER', 'CAREER')], default=None, max_length=30, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True, db_index=True)),
                ('type', models.CharField(choices=[('INTERNATION_SEA_SHIPPING', 'INTERNATION SEA SHIPPING')], default=None, max_length=30, null=True)),
